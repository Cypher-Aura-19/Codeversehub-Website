...
const socialLinks: { name: string; href: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm1.5 5.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5S12 7.83 12 7s.67-1.5 1.5-1.5zm-3.5 5c0-1.5 1.5-3 4-3s4 1.5 4 3-1.5 3-4 3-4-1.5-4-3zm7.5-1.5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-11 0c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5S5 11.33 5 10.5s.67-1.5 1.5-1.5zm5.5-3c-2.5 0-4.5.5-5.5 1.2-.3.2-.5.5-.5.8 0 .6.5 1 1 1h10c.6 0 1-.4 1-1 0-.3-.2-.6-.5-.8-1-.7-3-1.2-5.5-1.2z" />
      </svg>
    ),
  },
  {
