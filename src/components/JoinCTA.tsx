      ...
      <div className="relative max-w-4xl mx-auto">
        <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-10 md:p-16 text-center relative">
          ...
          <p className="relative z-10 text-white/50 text-base md:text-lg max-w-xl mx-auto mb-8">
            Developers helping each other ship code, review PRs, and build careers. No gatekeeping. No fake guru culture. Just good code and people who care.
          </p>
          ...
          <div className="relative z-10 flex items-center justify-center gap-3 mt-8">
            <div className="flex -space-x-2">
              {[
                ...
                <img key={i} src={c} alt="Community member" className="w-8 h-8 rounded-full border-2 border-black" />
              ))}
            </div>
            <span className="text-white/40 text-sm">Join thousands of developers</span>
          </div>
        </div>
      </div>
    </section>
