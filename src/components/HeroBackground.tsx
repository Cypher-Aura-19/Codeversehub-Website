...
export default function HeroBackground() {
  return (
    ...
    >
      ...
      {/* Layer 3 — Aurora band (CSS-only) */}
      <div className="aurora-band" />

      {/* Layer 4 — Large engineering grid */}
      <div
        className="absolute inset-0 bg-engineering-grid"
        style={{ zIndex: 4 }}
      />

      {/* Layer 5 — Noise texture */}
      <div
        className="absolute inset-0 bg-hero-noise pointer-events-none"
        style={{ zIndex: 5 }}
      />

      {/* Layer 6 — Blueprint decorations */}
