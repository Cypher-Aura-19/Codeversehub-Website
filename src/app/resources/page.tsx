...
const logos: Record<string, React.ReactNode> = {
    python: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Python">
            <path d="M12 2.5c-4.68 0-4.28 2.03-4.28 2.03l.01 2.07h4.36v.62H5.74S2 6.9 2 11.7c0 4.8 3.28 4.63 3.28 4.63h1.96v-2.23s-.06-2.66 2.62-2.66h4.51s2.53.04 2.53-2.46V5.08S19.68 2.5 12 2.5zM9.02 4.31c.45 0 .82.37.82.83 0 .46-.37.83-.82.83a.84.84 0 0 1-.83-.83c0-.46.37-.83.83-.83zM15.1 17.28h-4.51s-2.53-.04-2.53 2.46v2.28S7.07 24 14.78 24c4.68 0 4.28-2.03 4.28-2.03l-.01-2.07h-4.36v-.62h6.08s3.28.42 3.28-4.46c0-4.8-3.28-4.63-3.28-4.63h-1.96v2.23s.06 2.66-2.62 2.66z"/>
        </svg>
    ),
    rust: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Rust">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 2.5c4.14 0 7.5 3.36 7.5 7.5s-3.36 7.5-7.5 7.5-7.5-3.36-7.5-7.5S7.86 4.5 12 4.5zm0 2c-3.04 0-5.5 2.46-5.5 5.5s2.46 5.5 5.5 5.5 5.5-2.46 5.5-5.5-2.46-5.5-5.5-5.5zm0 2c1.93 0 3.5 1.57 3.5 3.5s-1.57 3.5-3.5 3.5-3.5-1.57-3.5-3.5 1.57-3.5 3.5-3.5zm0 1.5A2 2 0 0 0 10 14a2 2 0 0 0 2 2 2 2 0 0 0 2-2 2 2 0 0 0-2-2z"/>
        </svg>
    ),
    javascript: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="JavaScript">
            <path d="M0 0h24v24H0V0zm22.034 18.276c-.175-1.095-.888-2.015-3.003-2.873-.736-.345-1.554-.585-1.797-1.14-.091-.33-.105-.51-.046-.705.15-.646.915-.84 1.515-.66.39.12.75.42.976.9 1.034-.676 1.034-.676 1.755-1.125-.27-.42-.404-.601-.586-.78-.63-.705-1.469-.91-2.535-.79-1.095.12-2.01.63-2.415 1.635-.78 1.935.24 3.21 1.605 3.855 1.14.555 2.06.795 2.37 1.335.3.555.03 1.23-.78 1.41-.675.15-1.41-.06-1.875-.51-.075-.075-.15-.15-.225-.255-.93.705-.93.705-1.275 1.065.285.45.63.765 1.2 1.05.735.405 1.59.54 2.475.45 1.17-.12 1.95-.57 2.46-1.47 1.065-1.89-.06-3.675-1.77-4.5l-.015-.015zm-6.255-3.975c-.015.045-.03.075-.045.12-.045.105-.06.165-.06.24 0 .36.285.555.735.57l.24.015c.57.03 1.095-.12 1.47-.54.03-.045.06-.09.09-.135-.06-.03-.12-.075-.18-.105-.15-.075-.33-.12-.51-.135-.69-.06-1.17-.12-1.485.285l-.24.075z"/>
        </svg>
    ),
    cpp: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="C++">
            <path d="M12 2.5c-5.25 0-9.5 4.25-9.5 9.5s4.25 9.5 9.5 9.5 9.5-4.25 9.5-9.5S17.25 2.5 12 2.5zm0 2c4.14 0 7.5 3.36 7.5 7.5s-3.36 7.5-7.5 7.5-7.5-3.36-7.5-7.5S7.86 4.5 12 4.5zm-4 6.5h2v-2h1v2h2v1h-2v2h-1v-2H8v-1zm7 0h2v2h-2v-2zm-4 3h2v2h-2v-2z"/>
        </svg>
    ),
    java: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Java">
            <path d="M14.25 15.75c1.5-.75 3-1.5 4.5-2.25.75-.375 0-1.125-.375-1.125-1.125.375-2.25.75-3.375 1.125-.75.375-1.5.75-2.25 1.125-.75.375-1.5.75-1.125 1.5.375.75 1.125.375 1.5.375 1.125 0 2.625-.375 3.75-.75zm-3-3.75c1.125-.375 2.25-.75 3.375-1.125.75-.375 0-1.125-.375-1.125-1.125.375-2.25.75-3.375 1.125-.75.375-1.5.75-2.25 1.125-.375.375-.75.75-.375 1.125.375.375.75.375 1.125.375.75 0 1.5-.375 2.25-.75zm6.75 6.375c.375-.375.75-1.125 0-1.5-.75-.375-1.875-.75-3-1.125-.375-.125-.75-.25-1.125-.375-.375-.125-.75-.25-.75-.25.75.375 1.5.75 2.25 1.125.75.375 1.5.75 2.25 1.125.375.375.375.75.375 1.125 0 .75-.375 1.5-.75 2.25-.375.75-1.125 1.125-1.5 1.5.75-.375 1.5-.75 2.25-1.5.75-.75 1.125-1.875.75-2.625z"/>
        </svg>
    ),
    go: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Go">
            <path d="M4.5 9.5c.28-.28.28-.72 0-1s-.72-.28-1 0-.28.72 0 1 .72.28 1 0zm3.5-.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5-.5.22-.5.5.22.5.5.5zm.5 3.5c-.28 0-.5.22-.5.5s.22.5.5.5.5-.22.5-.5-.22-.5-.5-.5zM9 6.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5-.5.22-.5.5.22.5.5.5zM7 4.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5-.5.22-.5.5.22.5.5.5zM6 7c.28 0 .5-.22.5-.5S6.28 6 6 6s-.5.22-.5.5.22.5.5.5zm5.5 7.5c-.28.28-.28.72 0 1s.72.28 1 0 .28-.72 0-1-.72-.28-1 0zm4-4c-.28.28-.28.72 0 1s.72.28 1 0 .28-.72 0-1-.72-.28-1 0z"/>
        </svg>
    ),
};
