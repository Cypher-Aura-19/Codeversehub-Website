...
const logos: Record<string, React.ReactNode> = {
    ...
    rust: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Rust">
            <path d="M12 2.5c-2.76 0-5 2.24-5 5v1.5l-2.5 1.5v2.5L7 14.5V16c0 2.76 2.24 5 5 5s5-2.24 5-5v-1.5l2.5-1.5v-2.5L17 9V7.5c0-2.76-2.24-5-5-5zm0 2c1.66 0 3 1.34 3 3v2l2.5 1.5v.5L15 13v3c0 1.66-1.34 3-3 3s-3-1.34-3-3v-3l-2.5-1.5v-.5L9 9.5V7.5c0-1.66 1.34-3 3-3zm-1 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm2 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
        </svg>
    ),
    javascript: (
    ...
    java: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Java">
            <path d="M14.5 2.5c-.28.28-.5.67-.5 1.5 0 .83.22 1.22.5 1.5s.67.5 1.5.5.83-.22 1.5-.5c.28-.28.5-.67.5-1.5 0-.83-.22-1.22-.5-1.5S16.33 2 15.5 2s-1.22.22-1.5.5zM13 4c-.42 0-.79.1-1.06.44-.5.63-.44 1.51-.44 2.06 0 .55-.06 1.43.44 2.06.27.34.64.44 1.06.44h5c.42 0 .79-.1 1.06-.44.5-.63.44-1.51.44-2.06 0-.55.06-1.43-.44-2.06C18.79 4.1 18.42 4 18 4h-5zm0 7c-.42 0-.79.1-1.06.44-.5.63-.44 1.51-.44 2.06 0 .55-.06 1.43.44 2.06.27.34.64.44 1.06.44h5c.42 0 .79-.1 1.06-.44.5-.63.44-1.51.44-2.06 0-.55.06-1.43-.44-2.06C18.79 11.1 18.42 11 18 11h-5z"/>
        </svg>
    ),
    go: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5" aria-label="Go">
            <path d="M5.5 7.5c-.83 0-1.5.67-1.5 1.5v1c0 .83.67 1.5 1.5 1.5H7v1.5c0 .83.67 1.5 1.5 1.5h1c.83 0 1.5-.67 1.5-1.5V13H11c.83 0 1.5-.67 1.5-1.5v-1c0-.83.67-1.5 1.5-1.5h1c.83 0 1.5-.67 1.5-1.5V7c0-.83-.67-1.5-1.5-1.5h-7Zm7 3V9c0-.83.67-1.5 1.5-1.5h1c.83 0 1.5.67 1.5 1.5v1c0 .83-.67 1.5-1.5 1.5h-1c-.83 0-1.5-.67-1.5-1.5z"/>
        </svg>
    ),
};
