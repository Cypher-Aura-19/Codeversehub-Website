            ...
            <div className="flex flex-col gap-6 order-2 lg:order-1">
              ...
              <div className="space-y-2">
                ...
                <p className="text-white/50 text-base sm:text-lg md:text-xl leading-relaxed max-w-xl mt-4">
                  The Codeverse Hub is where developers actually build things. Not another Discord server
                  full of theory. We review your PRs, ship real projects, and help you grow from
                  &quot;I cloned a repo&quot; to &quot;I maintain one.&quot;
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-4">
                <div className="rounded-lg border border-white/[0.06] bg-white/[0.03] px-4 py-3">
                  <p className="text-[11px] text-white/40 font-medium tracking-wide">Members</p>
                  <p className="text-lg font-bold text-white">1.8k+</p>
                </div>
                <div className="rounded-lg border border-white/[0.06] bg-white/[0.03] px-4 py-3">
                  <p className="text-[11px] text-white/40 font-medium tracking-wide">Repos</p>
