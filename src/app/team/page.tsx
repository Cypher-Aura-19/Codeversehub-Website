            ...
            {maintainers.map((m) => (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-white font-semibold group-hover:text-[#ffffff] transition-colors duration-150 truncate">
                    {m.login}
                  </p>
                  <p className="text-white/40 text-sm">{m.role}</p>
                </div>
                <ExternalLink className="w-4 h-4 text-white/20 group-hover:text-[#ffffff] ml-auto shrink-0 transition-colors duration-150" />
              </a>
            ))}
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-sm text-[#ffffff] hover:text-[#ffffff] transition-colors duration-150"
            >
              ...
              {topContributors.map((c) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-white text-sm font-medium group-hover:text-[#ffffff] transition-colors duration-150 truncate">
                      {c.login}
                    </p>
                    <p className="text-white/30 text-xs">{c.contributions} contributions</p>
                  </div>
                  <ExternalLink className="w-3 h-3 text-white/15 group-hover:text-[#ffffff] shrink-0 transition-colors duration-150" />
                </a>
              ))}
            </div>
          ) : (
