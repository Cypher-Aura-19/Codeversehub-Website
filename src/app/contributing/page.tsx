...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to contribute to open-source projects at The Codeverse Hub from first PR to becoming a maintainer.",
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-16 w-full">
        ...
        <header className="mb-12">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-2xl">
            ...
            Here is how you can get started contributing to The Codeverse Hub
        ...
        <section className="mb-16">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {steps.map((step, i) => {
              ...
              return (
                <div key={step.title} className="cvh-card p-6 group relative">
        ...
        <section className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-8 md:p-12 text-center">
          ...
          <p className="text-white/50 max-w-xl mx-auto mb-6">
            Browse our open issues, find something that interests you, and
